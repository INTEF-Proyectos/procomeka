const e=[`CREATE TABLE IF NOT EXISTS "user" (
		...
		created_at TIMESTAMP NOT NULL DEFAULT NOW()
	)`,"CREATE INDEX IF NOT EXISTS idx_ratings_resource_id ON ratings(resource_id)","CREATE INDEX IF NOT EXISTS idx_favorites_resource_id ON favorites(resource_id)","CREATE INDEX IF NOT EXISTS idx_favorites_user_id ON favorites(user_id)","CREATE INDEX IF NOT EXISTS idx_comments_resource_id ON comments(resource_id)","CREATE INDEX IF NOT EXISTS idx_downloads_resource_id ON downloads(resource_id)","CREATE INDEX IF NOT EXISTS idx_resources_slug ON resources(slug)","CREATE INDEX IF NOT EXISTS idx_resources_status ON resources(editorial_status)","CREATE INDEX IF NOT EXISTS idx_resources_type ON resources(resource_type)","CREATE INDEX IF NOT EXISTS idx_upload_sessions_resource_id ON upload_sessions(resource_id)","CREATE INDEX IF NOT EXISTS idx_upload_sessions_owner_id ON upload_sessions(owner_id)","CREATE INDEX IF NOT EXISTS idx_upload_sessions_status ON upload_sessions(status)","CREATE INDEX IF NOT EXISTS idx_elpx_projects_hash ON elpx_projects(hash)","CREATE INDEX IF NOT EXISTS idx_elpx_projects_resource_id ON elpx_projects(resource_id)","CREATE INDEX IF NOT EXISTS idx_taxonomies_type ON taxonomies(type)",`DO $$ BEGIN
...
`;async function i(E){for(const T of e)await E.exec(T);await E.exec(N)}export{e as SCHEMA_STATEMENTS,i as createTables};
