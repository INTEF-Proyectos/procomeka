import{g as l}from"./get-api-client.C10olWbB.js";import{u}from"./paths.DDXL0-p6.js";import"./preload-helper.Bm1e3cF6.js";const a=document.getElementById("taxonomy-body"),o=document.getElementById("taxonomy-form");async function n(){const d=await l(),i=await d.listTaxonomies({limit:100,offset:0});a.innerHTML=i.data.map(t=>`
			<tr>
