...
export const DEMO_USERS: SeedUser[] = [
	// — Usuarios base (mantienen email para retrocompatibilidad) —
	{
		id: "demo-admin",
	...
	},
	{
		...
		role: "author",
		password: "password",
		bio: "Profesor de secundaria, apasionado por la innovación pedagógica",
	},
	{
		id: "demo-reader",
	...
	// — Usuarios nuevos del issue #64 —
	{
		id: "user-elena",
		email: "elena.martinez@edu.es",
		name: "Dra. Elena Martínez O.",
		role: "curator",
		password: "demo1234",
		bio: "Profesora universitaria especializada en IA aplicada a la educación",
	},
	{
		id: "user-carlos",
		email: "carlos.ruiz@edu.es",
		name: "Carlos M. Ruiz",
		role: "author",
		password: "demo1234",
	...
	{
		id: "user-marta",
		email: "marta.segovia@edu.es",
		name: "Marta Segovia",
		role: "author",
		password: "demo1234",
		bio: "Maestra de primaria especializada en matemáticas manipulativas",
	},
	{
		id: "user-sofia",
		email: "sofia.garcia@edu.es",
		name: "Sofía García",
		role: "author",
		password: "demo1234",
...
export const DEMO_RATINGS: SeedRating[] = [
	...
	{ resourceId: "res-01", userId: U.marta, score: 5 },
	{ resourceId: "res-01", userId: U.pedro, score: 4 },
	{ resourceId: "res-01", userId: U.reader, score: 5 },
	{ resourceId: "res-01", userId: U.curator, score: 4 },
	// res-03: Bot Robótica (media ~4.3)
	{ resourceId: "res-03", userId: U.elena, score: 5 },
	{ resourceId: "res-03", userId: U.carlos, score: 4 },
	{ resourceId: "res-03", userId: U.sofia, score: 4 },
	{ resourceId: "res-03", userId: U.reader, score: 4 },
	// res-07: Matemáticas Algoritmos (media ~4.5)
	{ resourceId: "res-07", userId: U.elena, score: 5 },
	{ resourceId: "res-07", userId: U.carlos, score: 4 },
	{ resourceId: "res-07", userId: U.lucia, score: 5 },
	{ resourceId: "res-07", userId: U.reader, score: 4 },
	// res-08: Cocina Matemática (media ~4.0)
	{ resourceId: "res-08", userId: U.sofia, score: 4 },
	{ resourceId: "res-08", userId: U.carlos, score: 4 },
	{ resourceId: "res-08", userId: U.lucia, score: 4 },
	// res-09: Cambio Climático (media ~4.3)
	{ resourceId: "res-09", userId: U.elena, score: 5 },
	{ resourceId: "res-09", userId: U.marta, score: 4 },
	{ resourceId: "res-09", userId: U.pedro, score: 4 },
	// res-13: Seguridad Internet (media ~4.0)
	{ resourceId: "res-13", userId: U.carlos, score: 4 },
	{ resourceId: "res-13", userId: U.marta, score: 4 },
	{ resourceId: "res-13", userId: U.sofia, score: 4 },
	// res-17: ABP Guía (media ~4.7)
	{ resourceId: "res-17", userId: U.elena, score: 5 },
	{ resourceId: "res-17", userId: U.marta, score: 5 },
	{ resourceId: "res-17", userId: U.carlos, score: 4 },
	{ resourceId: "res-17", userId: U.lucia, score: 5 },
	// res-19: Scratch (media ~4.3)
	{ resourceId: "res-19", userId: U.marta, score: 5 },
	{ resourceId: "res-19", userId: U.sofia, score: 4 },
	{ resourceId: "res-19", userId: U.reader, score: 4 },
	// res-02: IA Herramientas (media ~4.5)
	{ resourceId: "res-02", userId: U.elena, score: 5 },
	{ resourceId: "res-02", userId: U.pedro, score: 4 },
	{ resourceId: "res-02", userId: U.lucia, score: 5 },
	// res-06: Robots Amigos (media ~5.0)
	{ resourceId: "res-06", userId: U.marta, score: 5 },
	{ resourceId: "res-06", userId: U.elena, score: 5 },
	...
	{ resourceId: "res-15", userId: U.lucia, score: 4 },
...
export const DEMO_FAVORITES: SeedFavorite[] = [
	// Elena (5)
	{ resourceId: "res-03", userId: U.elena },
	{ resourceId: "res-07", userId: U.elena },
	{ resourceId: "res-17", userId: U.elena },
	{ resourceId: "res-19", userId: U.elena },
	{ resourceId: "res-09", userId: U.elena },
	// Carlos (4)
	...
	// Marta (3)
	{ resourceId: "res-01", userId: U.marta },
	{ resourceId: "res-06", userId: U.marta },
	{ resourceId: "res-19", userId: U.marta },
	// Sofía (3)
	{ resourceId: "res-07", userId: U.sofia },
	{ resourceId: "res-14", userId: U.sofia },
	{ resourceId: "res-01", userId: U.sofia },
	// Pedro (2)
	{ resourceId: "res-05", userId: U.pedro },
	{ resourceId: "res-20", userId: U.pedro },
	// Lucía (3)
	{ resourceId: "res-01", userId: U.lucia },
	{ resourceId: "res-09", userId: U.lucia },
	{ resourceId: "res-17", userId: U.lucia },
	// Cátedra (2)
