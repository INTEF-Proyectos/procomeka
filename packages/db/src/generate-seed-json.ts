...
const seedJson = {
	...
	activityEvents: [
		{ userId: "user-elena", type: "resource_published", resourceId: "res-01", resourceTitle: DEMO_RESOURCES[0]!.title, resourceSlug: DEMO_RESOURCES[0]!.slug, description: "Publico un nuevo recurso", daysAgo: 1 },
		...
		{ userId: "user-marta", type: "favorite_added", resourceId: "res-01", resourceTitle: DEMO_RESOURCES[0]!.title, resourceSlug: DEMO_RESOURCES[0]!.slug, description: "Anadio un recurso a favoritos", daysAgo: 3 },
		{ userId: "user-elena", type: "rating_given", resourceId: "res-03", resourceTitle: DEMO_RESOURCES[2]!.title, resourceSlug: DEMO_RESOURCES[2]!.slug, description: "Valoro un recurso con 5 estrellas", daysAgo: 4 },
		...
		{ userId: "user-pedro", type: "resource_published", resourceId: "res-20", resourceTitle: DEMO_RESOURCES[19]!.title, resourceSlug: DEMO_RESOURCES[19]!.slug, description: "Publico un nuevo recurso", daysAgo: 6 },
		{ userId: "user-sofia", type: "favorite_added", resourceId: "res-07", resourceTitle: DEMO_RESOURCES[6]!.title, resourceSlug: DEMO_RESOURCES[6]!.slug, description: "Anadio un recurso a favoritos", daysAgo: 7 },
		{ userId: "user-lucia", type: "resource_created", resourceId: "res-22", resourceTitle: DEMO_RESOURCES[21]!.title, resourceSlug: DEMO_RESOURCES[21]!.slug, description: "Creo un borrador", daysAgo: 1 },
		...
		{ userId: "user-marta", type: "resource_published", resourceId: "res-07", resourceTitle: DEMO_RESOURCES[6]!.title, resourceSlug: DEMO_RESOURCES[6]!.slug, description: "Publico un nuevo recurso", daysAgo: 12 },
		...
		{ userId: "user-pedro", type: "resource_published", resourceId: "res-15", resourceTitle: DEMO_RESOURCES[14]!.title, resourceSlug: DEMO_RESOURCES[14]!.slug, description: "Publico un nuevo recurso", daysAgo: 15 },
		{ userId: "user-lucia", type: "rating_given", resourceId: "res-07", resourceTitle: DEMO_RESOURCES[6]!.title, resourceSlug: DEMO_RESOURCES[6]!.slug, description: "Valoro un recurso con 5 estrellas", daysAgo: 9 },
