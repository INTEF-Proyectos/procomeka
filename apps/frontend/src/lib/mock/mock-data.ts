...
export const MOCK_RESOURCES: ResourceSummary[] = [
  ...
  },
  {
    ...
    language: "es",
    license: "cc-by-nc-sa",
    author: "Fran Rodríguez Castellano",
    thumbnailUrl: null,
...
export const MOCK_COLLECTIONS: Collection[] = [
  {
    ...
    resourceCount: 5,
    thumbnailUrl: null,
    curator: { id: "user-humberto", name: "Humberto Piñero" },
    editorialStatus: "published",
  ...
  },
  {
    ...
    resourceCount: 4,
    thumbnailUrl: null,
    curator: { id: "user-fran", name: "Fran Rodríguez Castellano" },
    editorialStatus: "published",
  ...
  },
  {
    ...
    resourceCount: 4,
    thumbnailUrl: null,
    curator: { id: "user-carlos", name: "Carlos Expósito" },
    editorialStatus: "published",
